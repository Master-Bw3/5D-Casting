...
import net.masterbw3.fivedimcasting.common.casting.actions.arithmetics.operator.nextRealNumber
...
class BinaryOperatorRealAndComplex(val op: (a: Double, b: Complex) -> Complex) : OperatorBasic(2,
    ...
    override fun apply(iotas: Iterable<Iota>, env: CastingEnvironment): Iterable<Iota> {
        ...
        val a = it.nextRealNumber()
        val b = it.nextComplexNumber()

        if (a <= 0) {
            throw MishapInvalidIota.ofType(DoubleIota(a), 1, "double.positive")
        }
