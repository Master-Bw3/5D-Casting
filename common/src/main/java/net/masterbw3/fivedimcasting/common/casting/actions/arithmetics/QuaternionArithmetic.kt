...
import net.masterbw3.fivedimcasting.common.casting.actions.arithmetics.operator.complex.BinaryOperatorComplex
import net.masterbw3.fivedimcasting.common.casting.actions.arithmetics.operator.complex.BinaryOperatorRealAndComplex
import net.masterbw3.fivedimcasting.common.casting.actions.arithmetics.operator.complex.UnaryOperatorComplex
import net.masterbw3.fivedimcasting.common.casting.actions.arithmetics.operator.quaternion.BinaryOperatorQuaternion
import net.masterbw3.fivedimcasting.common.casting.actions.arithmetics.operator.quaternion.OperatorGetQuaternionComponent
import net.masterbw3.fivedimcasting.common.casting.actions.arithmetics.operator.quaternion.UnaryOperatorQuaternion
