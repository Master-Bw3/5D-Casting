package net.masterbw3.fivedimcasting.common.casting.actions.eval
...
import net.masterbw3.fivedimcasting.api.casting.eval.vm.FrameCoolerEvaluate

object OpCoolerEval : Action {
    ...
    fun exec(env: CastingEnvironment, image: CastingImage, continuation: SpellContinuation, newStack: MutableList<Iota>, iota: Iota): OperationResult {
        ...
        val frame = FrameCoolerEvaluate(instrsList, true)
